...
namespace GlobalGames.Controllers
{
    public class BudgetsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Mensagem")] Budget budget)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Mensagem")] Budget budget)
        {
            if (id != budget.Id)
            {
                return NotFound();
